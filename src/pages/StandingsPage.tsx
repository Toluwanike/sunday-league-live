// StandingsPage.tsx
// Shows league standings for the active competition only
// Cup matches are excluded — only league matches count toward standings
...
export default function StandingsPage() {
  // Always scope to the active competition
  ...
  const standings = useMemo(() => {
    ...
    matches
      ...
      // Exclude cup matches — they don't count toward the league table
  ...
  // Top 4 qualify for the cup knockout stage
